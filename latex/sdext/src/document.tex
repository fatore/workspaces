...
O sistema mantém códigos em suas tabelas que possibilitam a comunicação com outros sistemas do governo inclusive com o IBGE. 

Apesar de se tratar de um recurso voltado para a saúde, esse sistema apresenta uma base de dados completa. Particularmente a seção de unidades territoriais é de extremo interesse para este trabalho, pois existe uma hierarquia completa de níveis de detalhamento geográfico que possibilita trabalhar de regiões nacionais até distritos de um município, como pode ser observado na Figura~\ref{fig:datasus_ut}. Para cada município o tem-se sua localização geográfica com base em sua latitude e longitude.
