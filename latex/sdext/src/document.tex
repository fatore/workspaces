...
A Tabela~\ref{tab:eleitorado} apresenta todos os atributos que compõem o arquivo de perfil do eleitorado.
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|l|l|}
        ...
        \hline
        0 & Ano Eleição & Integer \\
        \hline
        1 & UF da Zona Eleitoral & String \\
        \hline
        2 & Município da Zona Eleitoral & String \\
        \hline
        3 & Código TSE do Município & Integer \\
        \hline
        4 & Número da Zona Eleitoral  & Integer \\
        \hline
        5 & Sexo do Perfil & String \\
        \hline
        6 & Faixa Etária do Perfil & String \\
        \hline
        7 & Grau de Escolaridade do Perfil & String \\
        \hline
        8 & Quantidade de Eleitores no Perfil & Integer \\
        \hline
    \end{tabular}
...
\begin{figure}[htb]
    ...
    \caption{Subcategorias da categoria "candidatos".}
    \label{fig:rep_geral}
\end{figure}

Os arquivos correspondentes a informações de candidatura são os mais extensos e também os mais importantes para as análises propostas por este trabalho, pois contém informações importantes sobre os candidatos.
...
a ordem e, em alguns casos, até mesmo a existência de determinados campos varia de dados de anos diferentes. 
