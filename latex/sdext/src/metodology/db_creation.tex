...
\subsubsection{Nomes de cidades}

D'OESTE e DO OESTE 
MOGI MIRIM e MOJI MIRIM

\subsubsection{Nomes de candidatos}
...
Foram processados os arquivos pertencentes ao período de 2006 à 2012, resultando em um total de X eleições. Para 16 cidades do total de Y mesmo após à etapa de tratamento de ambiguidade mencionado na Subseção~\ref{sub:desamb} não foi possível realizar a correspondência com os dados do SUS. Porém, de qualquer modo essas cidades foram armazenadas no banco de dados, no entanto não poderão ser utilizadas em todas as análises propostas.
