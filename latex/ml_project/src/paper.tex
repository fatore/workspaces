...
Em trabalhos futuros deverá ser estudado se o fato de atributos, como partido político, serem representados por $n$ dimensões e outros atributos, como o atributo sexo, ser representado por somente uma dimensão pode interferir no desempenho da rede neural. Além disso, por falta de tempo não foi possível calcular outras medidas de avaliação dos resultados da MLP.
