...
import br.usp.sdext.models.old.Candidature;
import br.usp.sdext.models.old.Donor;
import br.usp.sdext.models.old.Election;
import br.usp.sdext.models.old.Expense;
import br.usp.sdext.models.old.GhostCandidate;
import br.usp.sdext.models.old.Income;
import br.usp.sdext.models.old.Log;
import br.usp.sdext.models.old.Provider;
...
public class AccountabilityParser extends AbstractParser {
	...
	private void parseIncomeLine(String line) throws Exception {
		...
		case 2006:
			...
			electionState = (State) State.persist(electionState, miscParser.getStatesMap());
		...
		case 2008:
			...
			electionTown = (Town) Town.persist(electionTown, miscParser.getTownsMap());
