...
import br.usp.sdext.models.old.Citizenship;
import br.usp.sdext.models.old.Job;
import br.usp.sdext.models.old.MaritalStatus;
import br.usp.sdext.models.old.Schooling;
...
public class CandidateParser extends ModelParser {
	...
	public Model parse(String[] pieces) throws Exception {
		...
		if (mapCandidate == null) {
			...
			birthState = (State) Model.persist(birthState, miscParser.getStatesMap());
			...
			birthTown = (Town) Model.persist(birthTown, miscParser.getTownsMap());
		...
		schooling = (Schooling) Model.persist(schooling, schMap);
